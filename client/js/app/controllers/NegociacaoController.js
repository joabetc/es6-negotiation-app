...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../views/NegociacoesView', '../views/MensagemView', '../services/NegociacaoService', '../services/NegociacaoFactory', '../helpers/DateHelper', '../helpers/Bind', '../models/Negociacao'], function (_export, _context) {
  ...
  var ListaNegociacoes, Mensagem, NegociacoesView, MensagemView, NegociacaoService, NegociacaoFactory, DateHelper, Bind, Negociacao, _createClass, NegociacaoController;
