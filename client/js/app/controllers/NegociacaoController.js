...
var NegociacaoController = function () {
  function NegociacaoController() {
    ...
    this._listaNegociacoes = new _Bind.Bind(new _ListaNegociacoes.ListaNegociacoes(), new _NegociacoesView.NegociacoesView($('#negociacoesView')), 'add', 'esvazia', 'sort', 'reverseOrder');
  ...
  _createClass(NegociacaoController, [{
    ...
    value: function _criaNegociacao() {
      return NegociacaoFactory.create('opcao', new _Negociacao.Negociacao(_DateHelper.DateHelper.textoParaData(this._inputData.value), parseInt(this._inputQuantidade.value), parseFloat(this._inputValor.value)));
    }
  }, {
